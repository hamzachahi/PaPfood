					...
					<div class="logmod__tab lgm-2">
						...
						<div class="logmod__form">
							<form accept-charset="utf-8" method="post" action="connexion"
								...
								<div class="simform__actions">
									<input type="submit" value="Connexion" onclick="retrieve()"
										class="sumbit" /> <span class="simform__actions-sidetext"><a
										class="special" role="link" href="#">Mot de passe oublié?<br>Cliquez
											ici
									</a></span>
								</div>
							</form>
