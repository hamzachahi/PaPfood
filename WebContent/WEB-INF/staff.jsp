...
<body class="home1">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="restaurent-menu-title">
					<h2 class="primery-title">Qui sommes-nous ?</h2>
					<h3 class="secondery-title">Toute l'équipe</h3>
				</div>
			</div>
		</div>
	</div>
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="page-inner padding-top-lg ">
					<div class="row">
						<div class="col-md-7">
						...
						<div class="col-md-5">
							<div class="stuff-image">
								<img src="assets/img/team/chef.png" alt="">
							</div>
						</div>
					</div>
				</div>
