...
(function() {
  ...
  EkkoLightbox = function(element, options) {
    ...
    footer = '<div class="modal-footer"' + (this.options.footer ? '' : ' style="display:none"') + '><div class="left-content"><h1>' + this.options.footer + '</h1><div class="model-description">'+ this.options.description +'</div></div><div class="social-icon"><h2>share this on:</h2><div class="facebook"><a href="#"><i class="fa fa-facebook-official" aria-hidden="true"></i>facebook</a></div><div class="twitter"><a href="#"><i class="fa fa-twitter-square" aria-hidden="true"></i>twitter</a></div></div></div>';
    $(document.body).append('<div id="' + this.modal_id + '" class="ekko-lightbox modal fade" tabindex="-1"><div class="modal-dialog"><div class="modal-content">' + header + '<div class="modal-body"><div class="ekko-lightbox-container"><div></div><span class="ekko-caption">'+this.options.captipontitle+'</span></div></div>' + footer + '</div></div></div>');
  ...
  EkkoLightbox.prototype = {
    ...
    updateTitleAndFooter: function() {
      var caption, footer, header, title, description, share_icon, captipontitle;
      header = this.modal_content.find('.modal-header');
      footer = this.modal_content.find('.modal-footer');
      title = this.$element.data('title') || "";
      caption = this.$element.data('footer') || "";
      description=this.$element.data('description') || "";
      captipontitle=this.$element.data('captipontitle') || "";
    ...
    resize: function(width) {
      var width_total;
      width_total = 970 + this.border.left + this.padding.left + this.padding.right + this.border.right;
  ...
  $.fn.ekkoLightbox.defaults = {
    ...
    left_arrow_class: '.ekko-left',
    right_arrow_class: '.ekko-right',
